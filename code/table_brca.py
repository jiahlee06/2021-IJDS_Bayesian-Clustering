...
def import_data(incsv):
    ...
    z = np.array(iris_df['diagnosis'].astype('category').cat.codes)
    m = np.array(iris_df.groupby('diagnosis').agg('mean')[cols])
...
if __name__ == "__main__":
    make_metric_table(brca_files[0], brca_files[1:5], brca_files[5:7])
