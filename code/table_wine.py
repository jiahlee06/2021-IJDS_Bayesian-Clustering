...
wine_files = ["data/wine.csv", "results/kmeans_wine.csv", "results/em_wine.csv", "results/minlp_wine.csv", "results/bandi_wine.csv",
                "results/metric-table_wine.csv", "results/metric-table_wine.tex"]
